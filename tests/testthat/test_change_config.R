...
test_that("get_config() returns value of a single option, if this is requested by a correct partial match",{
  ...
  expect_named(get_config("origin_I"), c("from"))
  expect_mapequal(get_config("origin_I"), movenetenv$options$movedata_cols["from"])
})
...
test_that("get_config() returns value of multiple options, if requested by partial matches as separate character strings",{
  ...
  expect_named(get_config("origin_I", "nr_pig"), c("from", "weight"))
  expect_mapequal(get_config("origin_I", "nr_pig"), movenetenv$options$movedata_cols[c("from","weight")])
})
test_that("get_config() returns value of multiple options, if requested by partial matches as a single character vector",{
  ...
  expect_named(get_config(c("origin_I", "nr_pig")), c("from", "weight"))
  expect_mapequal(get_config(c("origin_I", "nr_pig")), movenetenv$options$movedata_cols[c("from","weight")])
})
test_that("get_config() returns value of multiple options, if requested by partial matches as a single list",{
  ...
  expect_named(get_config(list("origin_I", "nr_pig")), c("from", "weight"))
  expect_mapequal(get_config(list("origin_I", "nr_pig")), movenetenv$options$movedata_cols[c("from","weight")])
})
...
test_that("get_config() returns the value of recognised options and a warning, if these are requested as separate character strings and include an unmatched option",{
  expect_warning(get_config("origin_IX", "weight"), "Ignoring unmatched or ambiguous")
  expect_vector(get_config("origin_IX", "weight"), ptype=list(), size = 1)
  expect_named(get_config("origin_IX", "weight"), c("weight"))
  expect_mapequal(get_config("origin_IX", "weight"), movenetenv$options$movedata_cols["weight"])
})
test_that("get_config() returns value of recognised options and a warning, if these are requested as single char vector, incl an unmatched option",{
  expect_warning(get_config(c("origin_IX", "weight")), "Ignoring unmatched or ambiguous")
  expect_vector(get_config(c("origin_IX", "weight")), ptype=list(), size = 1)
  expect_named(get_config(c("origin_IX", "weight")), c("weight"))
  expect_mapequal(get_config(c("origin_IX", "weight")), movenetenv$options$movedata_cols["weight"])
})
test_that("get_config() returns value of recognised options and a warning, if these are requested as list, and incl an unmatched option",{
  expect_warning(get_config(list("origin_IX", "weight")), "Ignoring unmatched or ambiguous")
  expect_vector(get_config(list("origin_IX", "weight")), ptype=list(), size = 1)
  expect_named(get_config(list("origin_IX", "weight")), c("weight"))
  expect_mapequal(get_config(list("origin_IX", "weight")), movenetenv$options$movedata_cols["weight"])
})
...
test_that("change_config() returns value of a single option, if this is requested by a correct partial match",{
  ...
  expect_named(change_config("origin_I"), c("from"))
  expect_mapequal(change_config("origin_I"), movenetenv$options$movedata_cols["from"])
})
