...
test_that("get_config() returns value of a single option, if this is requested by its full name",{
  expect_vector(get_config("movenet.origin_ID"), ptype=list(), size =1)
  expect_named(get_config("movenet.origin_ID"), c("movenet.origin_ID"))
  expect_mapequal(get_config("movenet.origin_ID"), movenetenv$options$movement_data["movenet.origin_ID"])
})
test_that("get_config() returns value of a single option, if this is requested by a correct partial match",{
  expect_vector(get_config("movenet.origin_I"), ptype=list(), size =1)
  expect_named(get_config("movenet.origin_I"), c("movenet.origin_ID"))
  expect_mapequal(get_config("movenet.origin_I"), movenetenv$options$movement_data["movenet.origin_ID"])
})
test_that("get_config() returns value of multiple options, if requested by their full names as separate character strings",{
  expect_vector(get_config("movenet.origin_ID", "movenet.nr_pigs"), ptype=list(), size = 2)
  expect_named(get_config("movenet.origin_ID", "movenet.nr_pigs"), c("movenet.origin_ID", "movenet.nr_pigs"))
  expect_mapequal(get_config("movenet.origin_ID", "movenet.nr_pigs"), movenetenv$options$movement_data[c("movenet.origin_ID","movenet.nr_pigs")])
})
test_that("get_config() returns value of multiple options, if requested by their full names as a single character vector",{
  expect_vector(get_config(c("movenet.origin_ID", "movenet.nr_pigs")), ptype=list(), size = 2)
  expect_named(get_config(c("movenet.origin_ID", "movenet.nr_pigs")), c("movenet.origin_ID", "movenet.nr_pigs"))
  expect_mapequal(get_config(c("movenet.origin_ID", "movenet.nr_pigs")), movenetenv$options$movement_data[c("movenet.origin_ID","movenet.nr_pigs")])
})
test_that("get_config() returns value of multiple options, if requested by their full names as a single list",{
  expect_vector(get_config(list("movenet.origin_ID", "movenet.nr_pigs")), ptype=list(), size = 2)
  expect_named(get_config(list("movenet.origin_ID", "movenet.nr_pigs")), c("movenet.origin_ID", "movenet.nr_pigs"))
  expect_mapequal(get_config(list("movenet.origin_ID", "movenet.nr_pigs")), movenetenv$options$movement_data[c("movenet.origin_ID","movenet.nr_pigs")])
})
test_that("get_config() returns value of multiple options, if requested by partial matches as separate character strings",{
  expect_vector(get_config("movenet.origin_I", "movenet.nr_pig"), ptype=list(), size = 2)
  expect_named(get_config("movenet.origin_I", "movenet.nr_pig"), c("movenet.origin_ID", "movenet.nr_pigs"))
  expect_mapequal(get_config("movenet.origin_I", "movenet.nr_pig"), movenetenv$options$movement_data[c("movenet.origin_ID","movenet.nr_pigs")])
})
test_that("get_config() returns value of multiple options, if requested by partial matches as a single character vector",{
  expect_vector(get_config(c("movenet.origin_I", "movenet.nr_pig")), ptype=list(), size = 2)
  expect_named(get_config(c("movenet.origin_I", "movenet.nr_pig")), c("movenet.origin_ID", "movenet.nr_pigs"))
  expect_mapequal(get_config(c("movenet.origin_I", "movenet.nr_pig")), movenetenv$options$movement_data[c("movenet.origin_ID","movenet.nr_pigs")])
})
test_that("get_config() returns value of multiple options, if requested by partial matches as a single list",{
  expect_vector(get_config(list("movenet.origin_I", "movenet.nr_pig")), ptype=list(), size = 2)
  expect_named(get_config(list("movenet.origin_I", "movenet.nr_pig")), c("movenet.origin_ID", "movenet.nr_pigs"))
  expect_mapequal(get_config(list("movenet.origin_I", "movenet.nr_pig")), movenetenv$options$movement_data[c("movenet.origin_ID","movenet.nr_pigs")])
})
test_that("get_config() returns a warning and an empty list, if a single option is requested but this is unmatched",{
  expect_warning(get_config("movenet.origin_IX"), "Ignoring unmatched or ambiguous")
  expect_vector(get_config("movenet.origin_IX"), ptype=list(), size =0)
})
...
test_that("get_config() returns the value of recognised options and a warning, if these are requested as separate character strings and include an unmatched option",{
  expect_warning(get_config("movenet.origin_IX", "movenet.nr_pigs"), "Ignoring unmatched or ambiguous")
  expect_vector(get_config("movenet.origin_IX", "movenet.nr_pigs"), ptype=list(), size = 1)
  expect_named(get_config("movenet.origin_IX", "movenet.nr_pigs"), c("movenet.nr_pigs"))
  expect_mapequal(get_config("movenet.origin_IX", "movenet.nr_pigs"), movenetenv$options$movement_data["movenet.nr_pigs"])
})
test_that("get_config() returns value of recognised options and a warning, if these are requested as single char vector, incl an unmatched option",{
  expect_warning(get_config(c("movenet.origin_IX", "movenet.nr_pigs")), "Ignoring unmatched or ambiguous")
  expect_vector(get_config(c("movenet.origin_IX", "movenet.nr_pigs")), ptype=list(), size = 1)
  expect_named(get_config(c("movenet.origin_IX", "movenet.nr_pigs")), c("movenet.nr_pigs"))
  expect_mapequal(get_config(c("movenet.origin_IX", "movenet.nr_pigs")), movenetenv$options$movement_data["movenet.nr_pigs"])
})
test_that("get_config() returns value of recognised options and a warning, if these are requested as list, and incl an unmatched option",{
  expect_warning(get_config(list("movenet.origin_IX", "movenet.nr_pigs")), "Ignoring unmatched or ambiguous")
  expect_vector(get_config(list("movenet.origin_IX", "movenet.nr_pigs")), ptype=list(), size = 1)
  expect_named(get_config(list("movenet.origin_IX", "movenet.nr_pigs")), c("movenet.nr_pigs"))
  expect_mapequal(get_config(list("movenet.origin_IX", "movenet.nr_pigs")), movenetenv$options$movement_data["movenet.nr_pigs"])
})
...
test_that("movenet.options() returns value of a single option, if this is requested by its full name",{
  expect_vector(movenet.options("movenet.origin_ID"), ptype=list(), size =1)
  expect_named(movenet.options("movenet.origin_ID"), c("movenet.origin_ID"))
  expect_mapequal(movenet.options("movenet.origin_ID"), movenetenv$options$movement_data["movenet.origin_ID"])
})
test_that("movenet.options() returns value of a single option, if this is requested by a correct partial match",{
  expect_vector(movenet.options("movenet.origin_I"), ptype=list(), size =1)
  expect_named(movenet.options("movenet.origin_I"), c("movenet.origin_ID"))
  expect_mapequal(movenet.options("movenet.origin_I"), movenetenv$options$movement_data["movenet.origin_ID"])
})
test_that("movenet.options() returns value of multiple options, if requested by their full names as separate character strings",{
  expect_vector(movenet.options("movenet.origin_ID", "movenet.nr_pigs"), ptype=list(), size = 2)
  expect_named(movenet.options("movenet.origin_ID", "movenet.nr_pigs"), c("movenet.origin_ID", "movenet.nr_pigs"))
  expect_mapequal(movenet.options("movenet.origin_ID", "movenet.nr_pigs"), movenetenv$options$movement_data[c("movenet.origin_ID","movenet.nr_pigs")])
})
test_that("movenet.options() returns value of multiple options, if requested by their full names as a single character vector",{
  expect_vector(movenet.options(c("movenet.origin_ID", "movenet.nr_pigs")), ptype=list(), size = 2)
  expect_named(movenet.options(c("movenet.origin_ID", "movenet.nr_pigs")), c("movenet.origin_ID", "movenet.nr_pigs"))
  expect_mapequal(movenet.options(c("movenet.origin_ID", "movenet.nr_pigs")), movenetenv$options$movement_data[c("movenet.origin_ID","movenet.nr_pigs")])
})
