...
```{R}
max_reachability <- parallel_summarise_temporal_node_properties(list(network), n_threads = 1,
...
```{R, echo = FALSE}
suppressWarnings(htmltools::includeHTML(file.path(tempdir(),"network_report.html")))
```
