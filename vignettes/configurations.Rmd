...
Note that the template config files include keys for several optional configurations (e.g. `herd_size`). These keys must be removed if you do not wish to use these optional configurations.
