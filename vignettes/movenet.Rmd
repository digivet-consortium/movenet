...
pseudonymisation, network analysis, and processing of movement and/or
holding data ready for use in transmission models. A first step in any of these
...
-   converting dates to R Date format, to improve inter-operability.
...
The movement data are now in a suitable format (movenet-format movement data tibble) 
to be plugged into pseudonymisation and network analysis workflows.
...
The holding data are now in a suitable format (movenet-format holding data tibble) 
to be plugged into pseudonymisation and network analysis workflows.

## Further reading

The movenet package contains additional vignettes as follows:

- [More details on configurations](configurations.html)
- [Network analysis of livestock movement data](network-analysis.html)
- [Pseudonymising livestock movement and holding data](pseudonymise.html)
