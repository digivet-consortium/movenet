...
This report follows analyses and recreates some plots from [Schulz J et
...
in common between two time periods. The black diagonal indicates that each
time period's movements are identical to themselves.
</div>
</div>
